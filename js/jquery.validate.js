...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		...
		//maxlength: jQuery.format("<br>Enter no more than {0} characters."),
//		maxLength: jQuery.format("<br>Enter no more than {0} characters."),
//		minlength: jQuery.format("<br>Enter at least {0} characters."),
//		minLength: jQuery.format("<br>Enter at least {0} characters."),
		maxlength: jQuery.format("<br>Vul maximaal {0} karakters in"),
		maxLength: jQuery.format("<br>Vul maximaal {0} karakters in"),
		minlength: jQuery.format("<br>Vul minimaal {0} karakters in"),
		minLength: jQuery.format("<br>Vul minimal {0} karakters in"),
	...
	methods: {
		...
		datenew: function(value, element) {
